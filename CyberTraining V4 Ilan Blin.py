...
class VocabularyDatabase:
    ...
    def __init__(self, db_name: str = "vocabulary.db"):
        ...
        self.connect() # Pour se connecter à la base de données SQL
        self.create_tables() # Crée une table dans la base de données
    ...
    def create_tables(self):
        ...
        self.conn.commit()  # Valide les changements de la base de données
    ...
    def close(self):
        """Fermer la connexion"""
        if self.conn:
            self.conn.close()  # Ferme la base de données
